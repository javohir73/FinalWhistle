...
async def cache_control(request: Request, call_next):
    ...
    if (
        ...
        # Research artifacts are experimental/shadow and regenerated by an
        # operator: a CDN-frozen copy could keep serving a superseded
        # benchmark after a correction. Never shared-cache them.
